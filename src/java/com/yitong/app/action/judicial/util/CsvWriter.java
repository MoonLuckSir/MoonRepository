...
public class CsvWriter {
	...
	public void write(String content, boolean preserveSpaces)
		...
		if (textQualify) {
			...
			if (userSettings.EscapeMode == ESCAPE_MODE_BACKSLASH) {
				content = replaceAll(content, "" + Letters.BACKSLASH, ""
						+ Letters.BACKSLASH + Letters.BACKSLASH);
				content = replaceAll(content, "" + userSettings.TextQualifier, ""
			...
			content = replaceAll(content, "" + Letters.BACKSLASH, ""
					+ Letters.BACKSLASH + Letters.BACKSLASH);
			content = replaceAll(content, "" + userSettings.Delimiter, ""
					+ Letters.BACKSLASH + userSettings.Delimiter);

			if (useCustomRecordDelimiter) {
				content = replaceAll(content, "" + userSettings.RecordDelimiter,
						"" + Letters.BACKSLASH + userSettings.RecordDelimiter);
			} else {
				content = replaceAll(content, "" + Letters.CR, ""
						+ Letters.BACKSLASH + Letters.CR);
				content = replaceAll(content, "" + Letters.LF, ""
	...
	public static String replaceAll(String original, String pattern, String replaceAll) {
