package com.yitong.app.service.judicial.fysfck;
...
public class FysfckService extends BaseService {
	...
	public IListPage pageQueryFyTask(Map params, int pageNo){
		return this.pageQuery("fyck.pageQueryFyTask", "fyck.pageCountFyTask", 
				params, pageNo);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public IListPage pageQueryZgfyTask(Map params, int pageNo){
		return this.pageQuery("fyck.pageQueryZgfyTask", "fyck.pageCountZgfyTask", 
				params, pageNo);
	}
