...
import com.yitong.commons.util.security.DESPlus;
...
public class StringUtil {
	 ...
	 * @return
	 */
	public static String getTransSerialNumber(){
		Random rand = new Random();
		long pross = rand.nextLong() ;
		long pross2 = rand.nextLong();
		
		String str = String.valueOf(pross);
		String str2 = String.valueOf(pross2);
		String str3 = str.substring(1,19) + str2.substring(1,11);
		
		return "402361018886_000000000000"+str3;
	...
	public static String getApplicationID(){
		...
		String str = String.valueOf(pross);
		String str2 = str.substring(1,19); 
		
		return "0403" + sdf.format(new Date()) + str2;
