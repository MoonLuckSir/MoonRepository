			...
			<tr>
				<td>
					<form name="form" method="post"
						action="${ctx}/judicial/sfck.shtml?action=addCxmb"
												...
												<table width="100%" border="0" cellpadding="1"
													...
													<tr>
														...
														<td width="50%" class="detail_content">
															<input name="CXMB_NAME" type="text" autocheck="true" label="模板名称"
													...
													<tr>
														...
														<td class="detail_content">
															<input name="CXMB_DEPT" type="text" pattern="string"
															    autocheck="true" label="所属部门" maxlength="10"
																>
														</td>
													</tr>
													...
													<tr>
														...
														<td class="detail_content">
															<textarea rows="5" cols="30" autocheck="true"  name="CXMB_DESC" pattern="string" label="备注"></textarea>
