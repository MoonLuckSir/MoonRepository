												...
												<table width="100%" border="0" cellpadding="1"
													...
													<tr>
														...
														<td width="75%" class="detail_content"> 
															<input style="width:200px;" readonly="readonly" class="readonly" name="taskIds" type="text" autocheck="true" required="true" label="任务编号"
													...
													<tr>
														...
														<td class="detail_content">
															<textarea rows="5"  cols="30" autocheck="true" readonly="readonly"  name="errorInfo" autocheck="true" required="true" pattern="string" label="查询报错信息">${param.errorInfo }</textarea>
