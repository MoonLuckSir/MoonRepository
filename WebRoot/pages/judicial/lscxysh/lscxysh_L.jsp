...
<html>
	...
	<body>
		<table width="100%" height="100%" border="0" cellspacing="0"
			...
			<tr>
				<td height="20">
					<form action="${ctx}/judicial/lscxysh.shtml?action=toList" method="post"
	...
	<script type="text/javascript">		
		...
		function viewEntry(REQ_NO){
			...
			"历史查询已审核","scrollbars=yes,resizable=yes,width=745,height=500,left=263,top=207");
		}
		function viewERP(){
			...
			window.open("${ctx}/judicial/ddbbzx.shtml?action=toViewREP&MKLX=YSH&REQ_NO="+REQ_NO+"&usrId=${usrId}&orgNo=${orgNo}",
