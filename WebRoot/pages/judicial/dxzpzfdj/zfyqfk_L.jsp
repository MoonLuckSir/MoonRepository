...
<html>
	<head>
		...
		<title>人民银行电信诈骗止付延期反馈信息查询</title>
	</head>
	<body>
				...
				<td height="27">
					<table width="100%" height="100%" cellspacing="0" cellpadding="0"
						...
						<tr>
							...
							<td>
								当前位置：司法查询 &gt;&gt; 人民银行电信诈骗查控列表 &gt;&gt; 止付延期反馈信息查询
							</td>
						...
						<table width="100%" border="0" cellpadding="1" cellspacing="1"
							...
							<c:forEach items="${page.result}" var="rst" varStatus="row">
								...
								<tr class="list_row${r}" id="${r}" onMouseOver="mover(this)" onMouseOut="mout(this)" >
									...
									<td align="center">
										<a href="${ctx}/judicial/zfdj.shtml?action=toYqfkView&APPLICATIONID=${rst.APPLICATIONID}">查看</a>
									</td>
								</tr>
							</c:forEach>
			...
			<tr>
				<td height="30" align="center">
					<table width="100%" height="100%" border="0" cellpadding="0"
						...
						<tr>
							<td>
								<form action="${ctx}/judicial/zfdj.shtml?action=toYqfkTaskList"
		...
		<form method="post" name="detailForm">
			<input type="hidden" name="_backUrl" value="${ctx}/judicial/zfdj.shtml?action=toYqfkTaskList">
