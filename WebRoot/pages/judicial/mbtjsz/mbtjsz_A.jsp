				...
				<td height="27">
					<table width="100%" height="100%" cellspacing="0" cellpadding="0"
						...
						<tr>
							...
							<td>
								当前位置：报表查询 &gt;&gt; 司法查询定制设计 &gt;&gt; 司法查询模板 &gt;&gt; 条件定制录入
							</td>
			...
			<tr>
				<td>
					<form name="form" method="post"
						action="${ctx}/judicial/mbtjsz.shtml?action=add"
											...
											<td class="detail2">
												<table width="100%" border="0" cellpadding="1"
													...
													<tr>
														...
														<td width="50%" class="detail_content">
															<input name="ZJCONS" type="text" autocheck="true" label="组件涉及列"
																pattern="string"   value="${rst.ZJCONS }">
														</td>
