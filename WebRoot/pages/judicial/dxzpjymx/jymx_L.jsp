...
<html>
	...
	<body>
		<table width="100%" height="100%" border="0" cellspacing="0"
				...
				<td height="27">
					<table width="100%" height="100%" cellspacing="0" cellpadding="0"
						...
						<tr>
							...
							<td>
								当前位置：司法查询 &gt;&gt; 人民银行电信诈骗查控列表 &gt;&gt; 账户交易明细查询
							</td>
			...
			<tr>
				<td height="20">
				 	<form action="${ctx}/judicial/jymx.shtml?action=toDxTaskList" method="post"
							...
							<c:forEach items="${page.result}" var="rst" varStatus="row">
								...
								<tr class="list_row${r}" id="${r}" onMouseOver="mover(this)" onMouseOut="mout(this)" >
									...
									<td align="center">
										...
										<c:if test="${rst.INQUIRYMODE eq '03'}">
												账户基本信息+交易明细
										</c:if>
										<c:if test="${rst.INQUIRYMODE eq '04'}">
												账户明细快速查询
										</c:if>
									</td>
									<td align="center">
									...
									<td align="center">
										${rst.INQUIRYPERIODSTART }
									</td>
									<td align="center">
										${rst.INQUIRYPERIODEND }
									</td>
									<td align="center">
									...
									<td align="center">
										<a href="${ctx}/judicial/jymx.shtml?action=toView&APPLICATIONID=${rst.APPLICATIONID}">查看</a>-
										<a href="${ctx}/judicial/jymx.shtml?action=toFkTaskList&APPLICATIONID=${rst.APPLICATIONID}">查询结果</a>-
										<c:choose>
											<c:when test="${not empty rst.ATTACHMENTS }">
												<a href="${ctx}/judicial/jymx.shtml?action=downLoadFile&savePath=${rst.ATTACHMENTS}">法律文书下载</a>-
											</c:when>
											<c:otherwise>
			...
			<tr>
				<td height="30" align="center">
					<table width="100%" height="100%" border="0" cellpadding="0"
						...
						<tr>
							<td>
								<form action="${ctx}/judicial/jymx.shtml?action=toDxTaskList"
		...
		<form method="post" name="detailForm">
			<input type="hidden" name="_backUrl" value="${ctx}/judicial/jymx.shtml?action=toDxTaskList">
	...
	<script type="text/javascript">	
		$("#plxz").click(function(){
			...
			detailForm.action="${ctx}/judicial/jymx.shtml?action=batchDownloadJymxInfo";
