...
<html>
	...
	<body>
		<table width="100%" height="100%" border="0" cellspacing="0"
			...
			<tr>
				<td height="20">
					<form action="${ctx}/judicial/gatck.shtml?action=toGatTaskList" method="post"
									...
									<td align="center">
										...
										<c:choose>
											<c:when test="${rst.TASK_STU eq 8 or rst.TASK_STU eq 9}">
												<a href="${ctx}/judicial/fyck.shtml?action=downLoadFile&savePath=${rst.MAKE_FILENAME}">下载生成文件</a>-
												<a href="${ctx}/judicial/fyck.shtml?action=downLoadFile&savePath=${rst.IMP_FILENAME}">下载查询文件</a>-
											</c:when>
	...
	function cz(){
		...
		function showErrorInfo(taskId,errorInfo){
			var url = "${ctx}/judicial/fyck.shtml?action=toErrorInfo&taskIds="+taskId+"&errorInfo="+errorInfo;
