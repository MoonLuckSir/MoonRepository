												...
												<table width="100%" border="0" cellpadding="1"
													...
													<tr>
														...
														<td width="75%" class="detail_content"> 
															<input readonly="readonly" class="readonly" name="taskId" type="text" autocheck="true" required="true" label="任务编号"
																pattern="string" value="${param.taskId}">
														</td>
													</tr>
													...
													<tr>
														...
														<td class="detail_content">
															<textarea rows="5"  cols="30" autocheck="true" readonly="readonly" name="makeInfo" autocheck="true" required="true" pattern="string" label="数据生成失败原因">${param.makeInfo }</textarea>
