			...
			<tr>
				<td>
					<form name="form" method="post"
						action="${ctx}/system/paramHis.shtml?action=add"
												...
												<table width="100%" border="0" cellpadding="1"
													...
													<tr>
														...
														<td width="75%" class="detail_content">
															<input name="id" type="text" autocheck="true" label="编号"
																pattern="int" maxlength="20" required="true">
														</td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td class="detail_content">
															<input name="tabYear" type="text" pattern="string" label="年度"
																size="50" autocheck="true" maxlength="4">
														</td>
													</tr>
													<tr>
														<td height="30" align="right" class="detail_label">
														...
														<td class="detail_content">
															<input name="tabcrc" type="text" pattern="string" label="系统渠道"
																size="50" autocheck="true" maxlength="50">
														</td>
													</tr>
													<tr>
														<td height="30" align="right" class="detail_label">
													...
													<tr>
														...
														<td class="detail_content">
															<input name="tabCol" type="text" pattern="string" label="表字段"
																size="50" autocheck="true" maxlength="2000">
														</td>
													</tr>
												</table>
											</td>
